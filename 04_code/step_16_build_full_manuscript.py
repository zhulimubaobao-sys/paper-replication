...
OUT = (
    BASE / "05_output/发送/"
    "步骤16-顶刊级完整初稿-DeepSeek事件与AI产业链非对称市场反应.docx"
)
...
add_noindent("")
add_noindent("投稿版完整初稿（步骤16）", bold=True)
add_noindent("")
...
add_body(
    ...
    "冲击如何在不同环节产生差异化反应。Patel and Sahi（2024）研究了服务业企业AI专利批准的"
    "市场反应，发现机器学习类AI专利获得正面反应，而规划控制类专利获得负面反应，暗示不同类型"
    "的AI技术具有不同的价值含义。但该研究仍未从产业链结构角度分析技术冲击的传导机制。本文"
    "通过将AI企业按产业链位置分类，直接检验技术冲击沿价值链的非对称定价效应，弥补了这一"
    "研究空白。"
)
...
add_body(
    ...
    "暗示，在技术冲击初期，上游企业可能更早受益，市场反应也更强。然而，现有研究大多关注"
    "实体经营层面的供应链传导，较少直接考察资本市场对同一技术事件的差异化即时反应。本文"
    "从AI产业链视角填补了这一空白。"
)

add_heading("（四）文献评述与研究缺口", 2)

add_body(
    "综合上述文献，可以发现三个主要研究缺口。第一，现有关于AI与资本市场的研究多关注整体市场"
    "反应或单一维度的企业暴露度，缺乏从产业链结构视角的系统分析。生成式AI作为通用技术，其"
    "影响必然沿产业链传导，但不同环节的反应强度和模式尚不清楚。第二，投资者注意力理论虽然"
    "已得到广泛验证，但在产业链层面的应用仍然不足。注意力在产业链不同环节的分布是否均匀、"
    "如何影响定价梯度，仍是待解的问题。第三，供应链冲击传导研究多聚焦于自然灾害、环境事件"
    "或贸易冲击，对技术进步型正向冲击的研究相对较少，且多关注长期经营效应，对短期市场反应"
    "的考察不足。"
)
...
add_body(
    ...
    "扩大事件窗口（[-3,+3]、[-5,+5]）、使用不同分类版本，核心结论均保持一致。"
...
add_body(
    ...
    "流动性和机构持股等因素有关。产权性质的异质性不显著，板块异质性表现为科创板>创业板>主板。"
)
...
add_body(
    ...
    "市场的反应模式，探讨制度环境、投资者结构和技术发展阶段的影响。"
)
